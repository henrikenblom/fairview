            ...
            <div id="content">
                ...
                <div class="list-body profile-list" id="credentials-list">
                    <form id="credentials_form" action="neo/ajax/update_credentials.do" method="post">
                        ...
                        <fieldset>
                            <div class="field-box"><div class="field-label-box">Användarnamn</div><div id="username-field-box" class="field-input-box"><input type="text" value="" autocomplete="off" onkeyup="validateNewUserForm()" name="username" class="text-field" id="username-field"></div></div>
                            <br>
                            <div class="field-box"><div class="field-label-box">Lösenord</div><div id="password_confirm_1-field-box" class="field-input-box"><input type="password" value="" autocomplete="off" onkeyup="validateNewUserForm()" name="password_confirm_1" class="text-field" id="password_confirm_1-field"></div></div>
                            <br>
                            <div class="field-box"><div class="field-label-box">Lösenord (bekräfta)</div><div id="password_confirm_2-field-box" class="field-input-box"><input type="password" value="" autocomplete="off" onkeyup="validateNewUserForm()" name="password_confirm_2" class="text-field" id="password_confirm_2-field"></div></div>
                            <br>
