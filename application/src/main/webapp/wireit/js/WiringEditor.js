(function() {
    ...
    WireIt.WiringEditor.prototype = {
        ...
        saveModuleSuccess: function(o) {
            ...
            this.alert("Dina ändringar har sparats");
        ...
        saveModuleFailure: function(errorStr) {
            this.alert("Ett fel uppstod : " + errorStr);
        },
            ...
            if (confirm("Are you sure you want to delete this wiring ?")) {
                ...
                this.adapter.deleteWiring({name: value.name, language: this.options.languageName}, {
                    ...
                    failure: function(errorStr) {
                        this.alert("Kan ej radera schemat: " + errorStr);
                    },
                    scope: this
                });
        ...
        load: function() {
            ...
            this.adapter.listWirings({language: this.options.languageName}, {
                success: function(result) {
                    this.onLoadSuccessTurbo(result);
                },
                failure: function(errorStr) {
                    this.alert("Kan ej ladda schemat: " + errorStr);
                },
                scope: this
            }
                    );
        ...
        onLoadSuccessTurbo: function(wirings) {
            this.pipes = wirings;
            this.pipesByName = {};
            this.renderLoadPanel();
            this.updateLoadPanelList();
            this.loadPipe("organization");
        },
        /**
        ...
        renderAlertPanel: function() {
            ...
            this.alertPanel.setHeader("Meddelande");
        ...
        markSaved: function() {
            //Dom.get('state').innerHTML = "&nbsp;";
        },

        markUnsaved: function() {
            //Dom.get('state').innerHTML = "<img onclick=\"editor.saveModule();\" src=\"/wireit/images/stock_save-as.png\" width=\"24\" height=\"24\"/>";
        },
        ...
        getValue: function() {
            ...
            return {
                name: obj.properties == null ? "none" : obj.properties.name,
                working: obj
            };
        }
