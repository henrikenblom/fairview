...
<%--not unobtrusive javascript,  because this is the only place where unitId is known--%>
    <li> <span id="unitsettings-general-tablink" name="unitsettings-general-tablink<%=unitId%>" onclick="generateSubunitPopup(<%=unitId%>); openUnitSettingsOnTab(0);"><%=unitName%></span>
<%
